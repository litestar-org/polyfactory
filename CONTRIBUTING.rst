...
1. `Fork <https://github.com/starlite-api/pydantic-factories/fork>`_ the upstream repository and clone the fork locally.
...
3. Commit and push.
4. In GitHub go to the `releases tab <https://github.com/starlite-api/pydantic-factories/releases>`_
5. Pick "`Draft a new release <https://github.com/starlite-api/pydantic-factories/releases/new>`_"
