...
def test_handle_constrained_float_handles_multiple_of_with_ge(val1: float, val2: float) -> None:
    ...
    if multiple_of != 0.0:
        ...
        with pytest.raises(ParameterError):
            handle_constrained_float(create_constrained_field(multiple_of=multiple_of, ge=min_value))
...
def test_handle_constrained_float_handles_multiple_of_with_gt(val1: float, val2: float) -> None:
    ...
    if multiple_of != 0.0:
        ...
        with pytest.raises(ParameterError):
            handle_constrained_float(create_constrained_field(multiple_of=multiple_of, gt=min_value))
